                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @else
                            ...
                            <li class="nav-item dropdown">
                                <button id="account-dropdown" class="btn shadow-note nav-link" data-bs-toggle="dropdown">
                                    @if (Auth::user()->avatar)
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="account-dropdown">
                                    ...
                                    {{-- Password Change --}}
                                    <a href="{{ route('changePassword', Auth::user()->id) }}" class="dropdown-item text-primary">
                        ...
                        <div class="col-3">
                            <div class="list-group">
                                <a href="{{ route('admin.users') }}"
                                    ...
                                    <i class="fa-solid fa-users"></i> Users {{ $userCount }}
                                </a>
                                <a href="{{ route('admin.posts') }}"
                                    class="list-group-item {{ request()->is('admin/posts') ? 'active' : '' }}">
                                    <i class="fa-solid fa-newspaper"></i> Posts {{ $postCount }}
                                </a>
                                <a href="{{ route('admin.categories') }}"
                                    class="list-group-item {{ request()->is('admin/categories') ? 'active' : '' }}">
                                    <i class="fa-solid fa-tags"></i> Categories {{ $categoryCount }}
                                </a>
                            </div>
                        </div>
                    @endif
